...
let tekiMaster =
[
    new TekiMaster(0, 10, 1, 100), //0,ピンクひよこ(右から2番目がHP、右端が撃破ボーナス)
    new TekiMaster(1, 10, 1, 100), //1,黄色ひよこ(右から2番目がHP、右端が撃破ボーナス)
    new TekiMaster(2, 70, 5000, 10000), //2,ボス（ひよこ黄）
    new TekiMaster(3, 10, 1, 10), //3,ボス（ひよこ黄）のこども
